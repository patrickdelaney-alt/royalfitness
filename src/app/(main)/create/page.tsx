  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-4 pb-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-lg font-bold" style={{ color: "#ffffff" }}>New Post</h1>
      </div>
      <div className="flex gap-2 mb-5 p-1 rounded-xl" style={{ background: "rgba(255,255,255,0.04)" }}>
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="flex-1 py-2 rounded-lg h-9 animate-pulse" style={{ background: "rgba(255,255,255,0.06)" }} />
        ))}
      </div>
      <div className="space-y-4">
        {[1, 2, 3].map((i) => (
